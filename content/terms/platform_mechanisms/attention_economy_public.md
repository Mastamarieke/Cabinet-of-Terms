...
version: V1
public_entry: attention_economy_public.md
...
related_mechanism:
  - attention-harvesting · recommender-systems · dopamine-feedback-loops
related_consequence:
  - doomscrolling · cognitive-surrender · deskilling
related_reaction:
...
Every platform you use is built on one assumption: your attention is worth money.

**Literal meaning**
*Attention* — focused mental engagement. *Economy* — system of exchange and value. The attention economy treats human focus as a scarce resource to be captured, held, and sold.

**Origin**
Herbert Simon identified the attention economy concept in 1971: in an information-rich world, attention becomes the scarce resource. Michael Goldhaber developed it in 1997. Tim Wu documented its commercial development in *The Attention Merchants* (2016).

> The attention economy is the economic model in which human attention is the primary commodity — captured by platforms and sold to advertisers.
