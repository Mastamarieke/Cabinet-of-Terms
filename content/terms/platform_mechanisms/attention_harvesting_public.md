...
version: V1
public_entry: attention_harvesting_public.md
...
related_mechanism:
  - recommender-systems · dopamine-feedback-loops · dark-patterns
related_consequence:
  - doomscrolling · cognitive-surrender · screen-time
related_reaction:
  - digital-detox · calm-technology
---
...
You opened the app to check one thing. Forty minutes later, you put it down.

**Literal meaning**
*Attention* — focused mental engagement. *Harvesting* — systematic extraction of a resource for commercial use.

**Origin**
The term circulates in technology criticism and platform studies. It gained traction as internal documents from Facebook, Twitter, and Google revealed deliberate design choices to maximise time-on-platform. Tristan Harris, former Google design ethicist, was instrumental in publicising the mechanisms in the mid-2010s.

> Attention harvesting is the systematic extraction of human attention through platform design — variable rewards, notifications, infinite scroll — optimised for engagement over wellbeing.
...
📖 **Read more**
- [Attention economy](https://en.wikipedia.org/wiki/Attention_economy) — Wikipedia
