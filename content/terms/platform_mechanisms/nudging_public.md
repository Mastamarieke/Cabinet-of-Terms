...
version: V1
public_entry: nudging_public.md
...
The healthy option is at eye level. The exit button is small and grey. You did not notice either of these choices being made for you.

**Literal meaning**
*Nudge* — a gentle push. Nudging is the practice of designing environments that steer behaviour in a predictable direction without prohibiting alternatives or offering incentives.

**Origin**
Richard Thaler and Cass Sunstein developed nudge theory in *Nudge* (2008), drawing on behavioural economics. Governments adopted nudge units for public health and policy. Digital platforms adopted nudging as a core design strategy — applying it not for public benefit but for engagement maximisation.

> Nudging is the design of choice environments to steer behaviour without explicit instruction — transparent in public health policy, invisible in platform design.
