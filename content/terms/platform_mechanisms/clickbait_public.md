...
version: V1
public_entry: clickbait_public.md
...
You will not believe what happened next. You clicked. You already knew you would.

**Literal meaning**
*Click* — the act of selecting a link. *Bait* — something used to lure. Clickbait is content designed primarily to generate clicks through curiosity gaps, emotional provocation, or withheld information.

**Origin**
The term emerged in the early 2010s as digital publishing shifted to engagement-based metrics. BuzzFeed and Upworthy pioneered headline formulas optimised for sharing. The format spread as publishers discovered that emotional provocation outperformed informational content in click-through rates.

> Clickbait is content designed to generate clicks rather than inform — using emotional triggers and withheld information to exploit curiosity.
...
📖 **Read more**
- [Clickbait](https://en.wikipedia.org/wiki/Clickbait) — Wikipedia
