...
**Literal meaning**
*BUMMER* — Behaviours of Users Modified and Made into an Empire for Rent. Jaron Lanier's acronym for the business model underlying dominant social media platforms.

**Origin**
Jaron Lanier introduced BUMMER in *Ten Arguments for Deleting Your Social Media Accounts Right Now* (2018). The acronym compresses the core mechanism: user behaviour is modified through algorithmic manipulation, and that modified behaviour is rented to advertisers.

> BUMMER is Jaron Lanier's term for the social media business model — platforms that modify user behaviour and sell that modification as a product.
...
- [Jaron Lanier](https://en.wikipedia.org/wiki/Jaron_Lanier) — Wikipedia
