...
version: V1
public_entry: provider_public.md
...
tags:
  ...
  - publieksversie
related_cause:
  - manosphere · womanosphere
related_mechanism:
  - smv-sexual-market-value · hypergamy · tradwife
related_consequence:
...
He pays. She stays. Both call it a choice.

**Literal meaning**
*Provider* — one who provides. In manosphere and womanosphere use: the male role in a relationship defined primarily by financial provision.

**Origin**
Provider as a gendered role has historical roots in breadwinner ideologies. It was reframed by manosphere communities in the 2010s as part of the SMV framework: a man's provider capacity is a quantifiable asset in the sexual marketplace.

> Provider, as used in manosphere and womanosphere discourse, is the male caretaker role reframed as an exchange contract — financial provision traded for domestic labour and sexual access.
