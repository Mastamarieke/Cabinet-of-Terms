...
version: V1
public_entry: top_1_percent_man_public.md
...
The goal is not just to be attractive. The goal is to be in the top one percent — and everyone knows what that means.
...
📖 **Read more**
- [Sexual market value](https://en.wikipedia.org/wiki/Incel#Incel_jargon) — Wikipedia
