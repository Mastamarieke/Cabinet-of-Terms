...
version: V1
public_entry: hustle_culture_public.md
...
related_consequence:
  ...
  - public/students/doom_spending_public
related_reaction:
  - []
---
...
Sleep is for the weak. The grind never stops. Rest is something you earn.

**Literal meaning**
*Hustle* — relentless effort, often associated with entrepreneurial striving. *Culture* — a shared set of values and norms. Hustle Culture is the ideology that equates constant productivity with identity and moral worth.

**Origin**
Hustle Culture has roots in Protestant work ethic discourse but took its current form in Silicon Valley startup ideology from the 2000s onward. Gary Vaynerchuk, Elon Musk, and similar figures popularised 80-hour work weeks as aspiration. It spread through social media as a visible lifestyle performance.

> Hustle Culture is the ideology that constant productivity is not just a means to an end but an identity and a virtue — distributed through platforms that profit from the aspiration it generates.
...
📖 **Read more**
- [Hustle culture](https://en.wikipedia.org/wiki/Hustle_culture) — Wikipedia
