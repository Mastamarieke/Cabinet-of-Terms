...
version: V1
public_entry: technostress_public.md
...
The update changed everything. The old way no longer works. You do not know where anything is. This is a feeling with a name.

**Literal meaning**
*Techno-* — technology. *Stress* — physiological and psychological strain. Technostress is stress directly caused by the use of technology or the inability to use it effectively.

**Origin**
Craig Brod coined Technostress in his 1984 book of the same name, describing the difficulty of adapting to computer technology in the workplace. The concept was expanded by Rosen and Weil in the 1990s and has been widely applied in organisational psychology. It is now documented across age groups but disproportionately affects older adults navigating rapidly changing interfaces.

> Technostress is stress produced by technology use — the psychological and physiological cost of navigating systems that change faster than users can adapt.
...
📖 **Read more**
- [Technostress](https://en.wikipedia.org/wiki/Technostress) — Wikipedia
- Brod, C. (1984): *Technostress*. Addison-Wesley
