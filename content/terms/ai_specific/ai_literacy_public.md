...
version: V1
public_entry: ai_literacy_public.md
...
You can use the tool. The question is whether you understand what it is doing — and what it is doing to you.

**Literal meaning**
*AI* — Artificial Intelligence. *Literacy* — the ability to read, understand, and critically engage. AI Literacy extends the concept of literacy to AI systems: not just using them, but understanding how they work.

**Origin**
AI literacy emerged as a policy and educational concept from around 2018 onward, as AI tools became embedded in daily life. UNESCO, the EU, and national education ministries developed frameworks. The concept is contested: definitions range from basic awareness to technical understanding to critical social analysis.

> AI Literacy is the capacity to understand, critically evaluate, and make informed decisions about AI systems — not just operate them.
...
📖 **Read more**
- [AI literacy](https://en.wikipedia.org/wiki/AI_literacy) — Wikipedia
