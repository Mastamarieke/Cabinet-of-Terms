...
version: V1
public_entry: cognitive_offloading_public.md
...
related_mechanism:
  - public/ai_specific/ai_dependency_public
  - public/platform_mechanisms/attention_harvesting_public
related_consequence:
  - public/students/deskilling_public
  - public/behaviour_relationships/cognitive_surrender_public
related_reaction:
...
You use your phone to remember the route, the appointment, the name. Your brain does not need to. The question is what happens to the capacity it no longer uses.

**Literal meaning**
*Cognitive* — relating to mental processes: memory, reasoning, attention. *Offloading* — transferring a task to something else. Cognitive offloading is the practice of delegating mental work to external tools.

**Origin**
Cognitive offloading is a documented human strategy with deep historical roots — writing itself is a form of offloading memory. The term gained urgency in cognitive science as digital tools became capable of handling increasingly complex mental tasks. Research by Betsy Sparrow (2011) documented the "Google effect": people remember less information when they know it can be retrieved easily.

> Cognitive offloading is the transfer of cognitive work to external tools — rational in the short term, with cumulative consequences for the capacities that go unused.
...
📖 **Read more**
- [Cognitive offloading](https://en.wikipedia.org/wiki/Cognitive_offloading) — Wikipedia
