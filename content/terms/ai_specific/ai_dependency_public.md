...
version: V1
public_entry: ai_dependency_public.md
...
related_mechanism:
  - ai-as-a-utility · recommender-systems
related_consequence:
...
You ask the AI. The AI answers. You move on. At some point, you stop wondering whether you could have figured it out yourself.

**Literal meaning**
*AI* — Artificial Intelligence. *Dependency* — structural reliance on a system you cannot easily leave or replace.

**Origin**
The term emerges from debates around automation and deskilling — first in manufacturing, now in knowledge work. As AI tools became embedded in daily workflows, researchers began documenting not just what AI enables but what it displaces.

> AI dependency is the structural reliance on artificial intelligence systems — not as a tool you choose to use, but as infrastructure you can no longer easily work without.
...
📖 **Read more**
- [AI and Deskilling](https://en.wikipedia.org/wiki/Deskilling) — Wikipedia
