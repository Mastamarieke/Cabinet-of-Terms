...
version: V1
public_entry: flexing_public.md
...
The car is rented for the photo. The watch is borrowed. The caption says nothing about either.

**Literal meaning**
*Flex* — slang for displaying strength or wealth. Flexing is the performative display of status symbols, possessions, or physical appearance online.

**Origin**
The term originates in hip-hop culture and entered mainstream internet vocabulary through social media in the 2010s. Platforms designed for visual display — Instagram, TikTok — created new infrastructure for status performance at scale.

> Flexing is the performative display of status — possessions, body, lifestyle — on platforms that amplify visibility and reward engagement with social validation.
...
📖 **Read more**
- [Flexing](https://en.wikipedia.org/wiki/Flex_(slang)) — Wikipedia
