...
The interface shows you what it is doing. The confirm-shaming button labels itself as confirm-shaming.
...
**The Appeal**
Radical transparency in design is both ethically principled and practically useful: users who understand what a system is doing can make genuinely informed choices.

**The Friction**
Detective Design is structurally self-defeating in commercial contexts: a platform that labels its own dark patterns loses the advantage those patterns provide. It survives in critical design projects, educational tools, and regulatory compliance contexts — not in dominant commercial platforms.
...
📖 **Read more**
- [Critical design](https://en.wikipedia.org/wiki/Critical_design) — Wikipedia
