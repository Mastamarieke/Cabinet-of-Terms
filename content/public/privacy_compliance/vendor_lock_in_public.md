...
version: V1
public_entry: vendor_lock_in_public.md
...
tags:
  ...
  - publieksversie
related_cause:
  - technofeudalism · surveillance-capitalism
related_mechanism:
  - cloud-act · brussels-effect
related_consequence:
...
Switching would cost you everything you have built. So you do not switch.

**Literal meaning**
*Vendor* — the company providing a product or service. *Lock-in* — a situation where switching to an alternative is prohibitively costly. Vendor lock-in is dependency by design.

**Origin**
The term originates in technology procurement and infrastructure debates. It describes situations where a customer becomes dependent on a specific supplier because migration costs — financial, technical, or operational — are prohibitive.

> Vendor lock-in is the condition of structural dependency on a single provider, where the cost of switching is high enough to function as permanent capture.
