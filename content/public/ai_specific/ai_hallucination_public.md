...
version: V1
public_entry: ai_hallucination_public.md
...
The AI gave you a confident answer. Complete with citations. None of them exist.

**Literal meaning**
*Hallucination* — in medicine, perceiving something that is not there. In AI, producing output that is factually wrong but linguistically convincing.

**Origin**
The term was adopted from psychology to describe a specific failure mode of large language models: generating plausible-sounding but false information. It became prominent as language models were deployed in high-stakes contexts from 2022 onward.

> AI Hallucination is the production of confident, fluent, factually wrong output by language models — a term that borrows from psychology while concealing that no perception is involved.
...
📖 **Read more**
- [Hallucination (artificial intelligence)](https://en.wikipedia.org/wiki/Hallucination_(artificial_intelligence)) — Wikipedia
