...
version: V1
public_entry: ai_ninja_public.md
...
He does not use AI. He wields it. His prompts are legendary. His outputs are elite. He is an AI ninja.

**Literal meaning**
*AI* — Artificial Intelligence. *Ninja* — a figure associated with exceptional, secretive skill. AI-ninja describes the identity constructed around advanced AI use as a form of mastery.

**Origin**
The term emerged alongside prompt engineering culture in 2022–2023. As AI tools became embedded in professional workflows, a discourse of mastery developed — some users constructing identities around their ability to extract superior outputs from AI systems.

> AI-ninja is the identity constructed around exceptional AI tool use — romanticising prompt skill as mastery while obscuring the dependency it represents.
