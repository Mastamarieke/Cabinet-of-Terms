...
version: V1
public_entry: cognitive_surrender_public.md
...
tags:
  ...
  - publieksversie
related_cause:
  - attention-harvesting · ai-dependency
related_mechanism:
  - doomscrolling · cognitive-offloading
related_consequence:
  - deskilling · filter-bubble
related_reaction:
  - digital-detox · ai-literacy
---
...
The AI gave you an answer. You accepted it. You did not check. You moved on.

**Literal meaning**
*Cognitive* — relating to thinking and reasoning. *Surrender* — giving up, yielding control. Cognitive surrender is the act of yielding one's own reasoning to a system.

**Origin**
The concept builds on research into automation bias — the documented tendency to over-rely on automated systems even when they are wrong. As AI tools became capable of producing fluent, confident-sounding text, the conditions for cognitive surrender expanded dramatically.

> Cognitive surrender is the habit of accepting what digital systems tell you without critical evaluation — not because you evaluated and agreed, but because checking felt unnecessary.
...
📖 **Read more**
- [Automation bias](https://en.wikipedia.org/wiki/Automation_bias) — Wikipedia
