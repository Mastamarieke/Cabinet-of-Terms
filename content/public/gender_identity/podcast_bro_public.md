...
version: V1
public_entry: podcast_bro_public.md
...
tags:
  ...
  - publieksversie
related_cause:
  - manosphere · attention-economy
related_mechanism:
  - smv-sexual-market-value · recommender-systems
related_consequence:
  - incel · blackpill · mgtow
related_reaction:
  - deplatforming
---
...
Three hours. No edits. Two men with microphones explaining how the world really works.

**Literal meaning**
*Podcast* — long-form audio or video content, typically conversational. *Bro* — informal male peer address; implies a specific cultural positioning: young, masculine, anti-establishment.

**Origin**
The format emerged in the mid-2010s as podcasting became mainstream. Joe Rogan's long-form interview format became the template. By the early 2020s, a recognisable genre had emerged: male hosts, multi-hour episodes, topics ranging from fitness to philosophy to politics, consistent framing of mainstream institutions as corrupt or weak.

> Podcast-bro describes a genre of long-form male-hosted content that frames traditional masculinity as rebellion — using the informality of conversation to distribute manosphere ideology to mainstream audiences.
...
📖 **Read more**
- [Joe Rogan Experience](https://en.wikipedia.org/wiki/The_Joe_Rogan_Experience) — Wikipedia
