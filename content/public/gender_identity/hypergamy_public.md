...
version: V1
public_entry: hypergamy_public.md
...
The claim sounds like a statistic: women always date up. But it is not a finding — it is a framework.

**Literal meaning**
*Hyper-* — above, beyond. *Gamy* — from Greek gamos, marriage. Literally: marrying above one's station.

**Origin**
Hypergamy is a sociological term from the 19th century describing the practice of marrying into a higher social class. It was adopted and radicalised by the manosphere in the 2010s — stripped of its original context and turned into a universal claim about female psychology.

> Hypergamy, as used in the manosphere, is the claim that women structurally and inevitably seek partners of higher status — used to explain rejection and justify resentment.
...
📖 **Read more**
- [Hypergamy](https://en.wikipedia.org/wiki/Hypergamy) — Wikipedia
