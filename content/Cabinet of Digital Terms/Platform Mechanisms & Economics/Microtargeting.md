...
**Origin:** **Microtargeting** originated in direct mail marketing in the 1990s and moved to digital platforms with the scaling of social media advertising. Cambridge Analytica's use of Facebook data to build psychographic profiles for political targeting in the 2016 US and UK elections brought the practice into mainstream public awareness. The technique exploits the same data infrastructure that powers commercial advertising, applied to political persuasion.

> The delivery of individually tailored messages based on detailed data profiles — so that different people see different versions of the same message, each tuned to persuade them specifically.
...
**Relevant terms:** [[Surveillance Capitalism]] · [[Recommender Systems]] · [[Bot Farms]] · [[Filter Bubble]] · [[Data Brokers]] · [[Narrative Engineering]] · [[Brussels Effect]]
