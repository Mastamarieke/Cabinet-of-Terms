...
**Origin:** **Family vlogging** emerged on **YouTube** from around 2012, as the platform's monetisation infrastructure matured and creators discovered that child-centred content performed well algorithmically. Channels like Ryan's World (now generating hundreds of millions of dollars in revenue) demonstrated the commercial scale possible. The format scaled globally. By 2020, **family vlogging** was an established content category with its own economy, conventions, and controversies.

> A content business that uses children's lives as primary material — where the child's experiences are the product and consent is not a legal requirement.
