...
**The Friction:** [[Digital-Military-Industrial Complex]] is the structural context: the entanglement of tech and defence makes dual-use not an edge case but the normal condition of advanced technology. **Niantic**'s LGM is a current example: trained on Pokémon Go player data, it has civilian mapping applications and military spatial intelligence applications — and the boundary between them is the subject of McClendon's "I could definitely see it" non-answer. [[Revolving Door]] personnel make dual-use governance more complex: regulators who have worked in defence companies regulate dual-use with institutional relationships that shape their judgments.
